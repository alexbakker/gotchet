...
__gotchet__ is a test report tool for Go. It can generate HTML reports for test
results. Its primary purpose is to make it a bit easier to analyze results of
large long-running test suites that make use of subtests and have lots of log
output.
